...
public class WhiteBishop extends Piece {
    ...
    public ArrayList<String> canMoveTo(Cell cell, HashMap<Cell, Piece> cellPiece){
        ...
        EnumSet<Cell.nameLinks> links = EnumSet.of(Cell.nameLinks.toUPLeft, Cell.nameLinks.toUPRight, Cell.nameLinks.toDownRight, Cell.nameLinks.toDownLeft);
    ...
    public void goLink(ArrayList<String> moveCells, Cell cell, HashMap<Cell, Piece> cellPiece, Cell.nameLinks link){
        ...
        if (cell.getLink(link) != null){
            goLink(moveCells,cell.getLink(link),cellPiece, Cell.nameLinks.toUPLeft);
        }
